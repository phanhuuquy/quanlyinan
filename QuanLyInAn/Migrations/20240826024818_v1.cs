    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignedShipments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrintingResourceInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPrintingCompleted = table.Column<bool>(type: "bit", nullable: false),
                    ShipperId = table.Column<int>(type: "int", nullable: false),
                    IsShipped = table.Column<bool>(type: "bit", nullable: false),
                    IsPrintingResourceSelected = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "Description", "ManagerId", "MemberCount", "Name" },
                values: new object[,]
                {
                    { 1, "Delivery department", null, 0, "Delivery" },
                    { 2, "Technical department", null, 0, "Technical" },
                    { 3, "Sales department", null, 0, "Sales" }
                });
